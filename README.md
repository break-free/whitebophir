...
Some important environment variables are :
 ...
 - `DELETE_ON_LEAVE` : (default: `true`) whether the board gets deleted if the last user leaves or not. NOTE: This is hard-coded and must be changed in the `configuration.js` file.
